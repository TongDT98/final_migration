...
namespace TransporaMirgateData.DataFrom
{
    public class TransporaDBContext : DbContext
    {
        ...
        {
           // optionsBuilder.UseMySql("server=localhost;port=3306; database=datatest; user=root; password=050698", ServerVersion.AutoDetect(@"server=localhost;port=3306; database=datatest; user=root; password=050698"));
            optionsBuilder.UseMySql("server=210.245.85.229;port=3316; database=transpora_mg_pr; user=root; password=Thanhbipkeo@123", ServerVersion.AutoDetect(@"server=210.245.85.229;port=3316; database=transpora_mg_pr; user=root; password=Thanhbipkeo@123"));
