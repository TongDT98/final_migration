       ...
       private static void UpdateLocation()
        ...
        private static void MigrateTender()
        {
            ...
            using (var dbfrom = new TransporaDBFromContext())
            {
                ...
                foreach (var item in listTender)
                {
                    ...
                    var cid = Int32.Parse(item.atr_tenders_companyid);
                    ...
                    if (item.atr_tenders_id <= 16)
                    {
                        ...
                        if (fromContachcheck == null)
                        {
                            ...
                            if (!string.IsNullOrEmpty(item.atr_tenders_fromcontactnumber))
                            {
                                ...
                                var phoneresult = ReplacePhoneNumber1.ReplacePhoneNumber(item.atr_tenders_fromcontactnumber);
                        ...
                        if (toContachcheck == null)
                        {
                            ...
                            if (!string.IsNullOrEmpty(item.atr_tenders_tocontactnumber))
                            {
                                ...
                                //}
                                var phoneresult = ReplacePhoneNumber1.ReplacePhoneNumber(item.atr_tenders_fromcontactnumber);
                                phonecode1 = phoneresult.PhoneCode;
                                phonenumber1 = phoneresult.PhoneNumber;
                            }
                        ...
                        var addressFrom = context.Addresses.FirstOrDefault(x =>
                            ...
                            && x.CompanyId == cid
                            && x.AddressName == item.atr_tenders_fromcompany
                        ...
                        if (addressFrom == null)
                        {
                            var addf = context.Addresses.Add(new Address()
                            {
                                ...
                                AddressName = item.atr_tenders_fromcompany,
                                IsDefault = false,
                                CountryId = 1,
                        ...
                        var addressTo = context.Addresses.FirstOrDefault(x =>
                            ...
                            && x.AddressName == item.atr_tenders_tocompany
                            && x.CompanyId == cid 
                        ...
                        if (addressTo == null)
                        {
                            var addf = context.Addresses.Add(new Address()
                            {
                                AddressName = item.atr_tenders_tocompany,
                   ...
                   if(item.atr_tenders_id > 16)
                    {
                        ...
                        foreach (var transport in listtransport)
                        {
                            var fromContachcheck1 = context.Contacts.FirstOrDefault(x =>
                                ...
                                x.CompanyId == transport.atr_freight_companyid
                            );
                            ...
                            if (fromContachcheck1 == null)
                            {
                                ...
                                if (!string.IsNullOrEmpty(transport.atr_freight_fromcontactnumber))
                                {
                                    ...
                                    //    }
                                    //}
                                    var phone = ReplacePhoneNumber1.ReplacePhoneNumber(transport.atr_freight_fromcontactnumber);
                                    phonecode1 = phone.PhoneCode;
                            ...
                            var addressFrom1 = context.Addresses.FirstOrDefault(x =>
                                ...
                                && x.AddressName.Equals(transport.atr_freight_fromcompany)
                                && x.CompanyId == transport.atr_freight_companyid
                            ...
                            if (addressFrom1 == null)
                            {
                                ...
                                {
                                    AddressName = transport.atr_freight_fromcompany,
                            ...
                            var addressTo1 = context.Addresses.FirstOrDefault(x =>
                                ...
                                && x.CompanyId == transport.atr_freight_companyid
                                && x.AddressName.Equals(transport.atr_freight_tocompany)
                            ...
                            if (addressTo1 == null)
                            {
                                var addf1 = context.Addresses.Add(new Address()
                                {
                                    AddressName = transport.atr_freight_tocompany,
        ...
        private static void MigrateMachines()
        {
            ...
            using (var dbfrom = new TransporaDBFromContext())
            {
                ...
                {
                    var img = $"{loadurl}{item.atr_machines_id}.png";
                    var List = new List<string>();
                    List.Add(img);
                    ...
                    context.Loads.Add(new Load()
                    {
                        ...
                        ImageUrls = JsonConvert.SerializeObject(List),
        ...
        private static void MigrateCompany()
        {
            ...
            using (var dbfrom = new TransporaDBFromContext())
            {
...

                {
                    ...
                    {
                        var phoneresult = ReplacePhoneNumber1.ReplacePhoneNumber(phone);
                        phonecode = phoneresult.PhoneCode;
                        phonenumber = phoneresult.PhoneNumber;
                    }
                    ...
                    var companyurl = "http://210.245.85.229:9967/Images/CompanyLogo/";
                    var img = item.atr_companies_imagedata;
                    if (!string.IsNullOrEmpty(img))
                    {
                        img = $"{companyurl}{item.atr_companies_imagedata}";
                    }
        ...
        private static void MigrateUser()
        {
            ...
            using (var dbfrom = new TransporaDBFromContext())
            {
                ...
                var avatar = "http://210.245.85.229:9967/Images/AvatarUsers/";
                foreach (var item in list)
                {
                    ...
                    {
                        var phoneresult1 = ReplacePhoneNumber1.ReplacePhoneNumber(mobile);
                        mobilecode = phoneresult1.PhoneCode;
                        mobilenumber = phoneresult1.PhoneNumber;
                    }
                    ...
                    context.Users.Add(new User()
                    {
                        ...
                        Image = $"{avatar}{id}.png",
                        IsLoginMd5 = true,
                        Md5Hash = item.atr_users_password,
                        //pass: 123456
